...
vertex v2f basic_vertex( uint vertexId [[vertex_id]], device const v2f* vert [[buffer(0)]], device const float2* winSize [[buffer(1)]]) {

    float2 win = float2((*winSize).xy / 2);
